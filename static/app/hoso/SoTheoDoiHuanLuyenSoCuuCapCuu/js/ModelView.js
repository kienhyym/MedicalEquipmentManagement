define(function (require) {
	...
	var template = require('text!app/hoso/SoTheoDoiHuanLuyenSoCuuCapCuu/tpl/model.html'),
		schema = require('json!schema/SoTheoDoiCongTacHuanLuyenSoCuuCapCuuTaiNoiLamViecSchema.json');

	var GiangVienThucHienHuanLuyenItemView = require('app/hoso/SoTheoDoiHuanLuyenSoCuuCapCuu/js/GiangVienThucHienHuanLuyenView');
	var BangDanhSachThanhVienLucLuongSoCuuDuocHuanLuyenItemView = require('app/hoso/SoTheoDoiHuanLuyenSoCuuCapCuu/js/BangDanhSachThanhVienLucLuongSoCuuDuocHuanLuyenView');
	var BangDanhSachNguoiLaoDongDuocHuanLuyenItemView = require('app/hoso/SoTheoDoiHuanLuyenSoCuuCapCuu/js/BangDanhSachNguoiLaoDongDuocHuanLuyenView');
