define(function (require) {
	...
	var template = require('text!app/hoso/TongHopKetQuaKhamDinhKyNguoiMacBNN/tpl/model.html'),
		schema = require('json!schema/TongHopKetQuaKhamDinhKyNguoiMacBenhNgheNghiepSchema.json');
		
	var TongHopKetQuaKhamDinhKyChoNguoiLaoDongMacBNNItemView = require('app/hoso/TongHopKetQuaKhamDinhKyNguoiMacBNN/js/TongHopKetQuaKhamDinhKyChoNguoiLaoDongMacBNNItemView');
