define(function (require) {
    ...
    var itemTemplate = require('text!app/hoso/HoSoSucKhoeVaBenhTat/tpl/bangquanlybenhmantinhtheotungbenh.html'),
        itemSchema = require('json!schema/BangQuanLyBenhManTinhTheoTungBenhSchema.json');
    var BangQuanLyBenhManTinhTheoTungBenhChiTietItemView = require('app/hoso/HoSoSucKhoeVaBenhTat/js/BangQuanLyBenhManTinhTheoTungBenhChiTietView');
