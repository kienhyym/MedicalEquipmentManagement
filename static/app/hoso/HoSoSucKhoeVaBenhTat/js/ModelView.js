define(function (require) {
	...
	var template = require('text!app/hoso/HoSoSucKhoeVaBenhTat/tpl/model.html'),
		schema = require('json!schema/HSQLSucKhoeVaBenhTatNguoiLaoDongSchema.json');

	var BangQLSucKhoeTruocKhiBoTriViecLamItemView = require('app/hoso/HoSoSucKhoeVaBenhTat/js/BangQLSucKhoeTruocKhiBoTriViecLamView');
	var BangQLSucKhoeLaoDongThongQuaKhamSucKhoeDinhKyItemView = require('app/hoso/HoSoSucKhoeVaBenhTat/js/BangQLSucKhoeLaoDongThongQuaKhamSucKhoeDinhKyView');
	var BangSoTruongHopMacCacLoaiBenhThongThuongItemView = require('app/hoso/HoSoSucKhoeVaBenhTat/js/BangSoTruongHopMacCacLoaiBenhThongThuongVIew');

	var BangCacTruongHopMacBenhNgheNghiepItemView = require('app/hoso/HoSoSucKhoeVaBenhTat/js/BangCacTruongHopMacBenhNgheNghiepView');
	var BangCacTruongHopTaiNanLaoDongItemView = require('app/hoso/HoSoSucKhoeVaBenhTat/js/BangCacTruongHopTaiNanLaoDongView');
	// var BangTinhHinhNghiViecItemView = require('app/hoso/HoSoSucKhoeVaBenhTat/js/BangTinhHinhNghiViecView');
	var BangQuanLyBenhManTinhItemView = require('app/hoso/HoSoSucKhoeVaBenhTat/js/BangQuanLyBenhManTinhView');
	var BangQuanLyBenhManTinhTheoTungBenhView = require('app/hoso/HoSoSucKhoeVaBenhTat/js/BangQuanLyBenhManTinhTheoTungBenhView');
	var BangTheoDoiBenhNgheNghiepItemView = require('app/hoso/HoSoSucKhoeVaBenhTat/js/BangTheoDoiBenhNgheNghiepView');
	var BangDanhSachNguoiLaoDongMacBenhNgheNghiepItemView = require('app/hoso/HoSoSucKhoeVaBenhTat/js/BangDanhSachNguoiLaoDongMacBenhNgheNghiepView');
	var BangTinhHinhNghiViecView = require('app/hoso/HoSoSucKhoeVaBenhTat/js/BangTinhHinhNghiViecView');
