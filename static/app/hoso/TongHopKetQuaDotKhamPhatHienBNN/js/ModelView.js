define(function (require) {
	...
	var template = require('text!app/hoso/TongHopKetQuaDotKhamPhatHienBNN/tpl/model.html'),
		schema = require('json!schema/TongHopKetQuaDotKhamSucKhoePhatHienBenhNgheNghiepSchema.json');

	var KetQuaKhamSucKhoeItemView = require('app/hoso/TongHopKetQuaDotKhamPhatHienBNN/js/KetQuaKhamSucKhoeItemView');
	var DanhSachNguoiMacBenhNgheNghiepItemView = require('app/hoso/TongHopKetQuaDotKhamPhatHienBNN/js/DanhSachNguoiMacBenhNgheNghiepItemView');
	var TongHopKetQuaKhamBenhNgheNghiepItemView = require('app/hoso/TongHopKetQuaDotKhamPhatHienBNN/js/TongHopKetQuaKhamBenhNgheNghiepItemView');
	var KienNghiCuaDonKhamItemView = require('app/hoso/TongHopKetQuaDotKhamPhatHienBNN/js/KienNghiCuaDonKhamItemView');
