define(function (require) {
    ...
    var template = require('text!app/chungtu/phieuyeucausuachua/tpl/collection.html'),
    ...
    return Gonrin.CollectionView.extend({
        ...
        locData: function () {
            ...
            $.ajax({
                url: self.getApp().serviceURL + "/api/v1/phieuyeucausuachua?results_per_page=100000&max_results_per_page=1000000",
                method: "GET",
                    ...
                    self.$el.find('#ngaycap').blur(function () {
                        ...
                        if (arr.length != 0) {
                            ...
                            arr.forEach(function (item, index) {
                                if (moment(item.ngay_suco * 1000).format("DDMMYYYY") == moment(x * 1000).format("DDMMYYYY")) {
                                    item.stt = i;
                                    i++;
                                    arr2.push(item)
                                }
        ...
        render_grid: function (dataSource) {
            ...
            element.grid({
                ...
                events: {
                    "rowclick": function (e) {
                        self.getApp().getRouter().navigate("phieuyeucausuachua/model?id=" + e.rowId);
                    },
                },
            });
