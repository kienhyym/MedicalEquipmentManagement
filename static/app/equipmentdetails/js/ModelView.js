define(function (require) {
	...
	var NhaCungCapSelectView = require('app/danhmuc/organization/js/SelectView');
	...
	return Gonrin.ModelView.extend({
		...
		render: function () {
			...
			self.model.set("medicalequipment_id", sessionStorage.getItem('IDSanPham'))
				...
				this.model.fetch({
					...
					success: function (data) {
						...
						self.$el.find(".btn-taokiemtrahangngay").unbind("click").bind("click", function () {
							...
							sessionStorage.setItem('ThietBiID', self.model.get("medicalequipment_id"));
