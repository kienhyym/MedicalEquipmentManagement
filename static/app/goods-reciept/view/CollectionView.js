define(function (require) {
	...
	var template = require('text!app/goods-reciept/tpl/collection.html'),
	...
	return Gonrin.CollectionView.extend({
		...
		uiControl: {
			...
			fields: [
				{
					field: "goodsreciept_no", label: "Mã phiếu", template: function (rowObject) {
				...
				{
					field: "", label: "Trạng thái", template: function (rowObject) {
						if (rowObject.payment_status) {
							if (rowObject.payment_status == "done") {
								return `<label style="width: 70px" class="badge badge-info">Đã về kho</label>`;
				...
				{
					field: "created_at", label: "Thời gian", template: function (rowObject) {
				...
				{
					field: "", label: "Mã TT", template: function (rowObject) {
				...
				{
					field: "", label: "Kho", template: function (rowObject) {
				...
				{
					field: "", label: "Người tạo", template: function (rowObject) {
				...
				{
					field: "", label: "Tổng SL", template: function (rowObject) {
				...
				{
					field: "", label: "Tổng thuế", template: function (rowObject) {
				...
				{
					field: "", label: "Tổng tiền", visible: true, template: function (rowObject) {
						if (rowObject.amount) {
