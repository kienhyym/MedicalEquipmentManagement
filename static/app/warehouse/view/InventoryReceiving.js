define(function (require) {
    ...
    var template = require('text!app/view/warehouse/tpl/inventory-receiving.html');
    ...
    var DeliveryDialog = require('app/view/warehouse/view/DeliveryDialog')
    ...
    return Gonrin.ModelView.extend({
        ...
        loadData: function (warehouseID) {
            ...
            loader.show();
            $.ajax({
                url: self.getApp().serviceURL + "/api/v1/product/get_all_inventory_receiving",
                type: "POST",
        ...
        renderData: function (data) {
            ...
            self.$el.find("#grid").grid({
                ...
                onRowClick: function (event) {
                    console.log(event);
                    var deliveryDialog = new DeliveryDialog();
                    deliveryDialog.model.set(event.rowData);
