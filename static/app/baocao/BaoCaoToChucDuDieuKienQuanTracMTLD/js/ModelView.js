define(function (require) {
	...
	var template = require('text!app/baocao/BaoCaoToChucDuDieuKienQuanTracMTLD/tpl/model.html'),
		schema = require('json!schema/BaoCaoToChucDuDieuKienQuanTracMoiTruongLaoDongDuocCongBoSchema.json');

	var CacYeuToVatLyKhac_ItemView = require('app/baocao/BaoCaoToChucDuDieuKienQuanTracMTLD/js/CacYeuToVatLyKhacView');
	var CacLoaiBuiKhac_ItemView = require('app/baocao/BaoCaoToChucDuDieuKienQuanTracMTLD/js/CacLoaiBuiKhacView');
	var CacHoaChatKhac_ItemView = require('app/baocao/BaoCaoToChucDuDieuKienQuanTracMTLD/js/CacHoaChatKhacView');
	var CacYeuToKhac_ItemView = require('app/baocao/BaoCaoToChucDuDieuKienQuanTracMTLD/js/CacYeuToKhacView');
