define(function (require) {
	...
	var template = require('text!app/baocao/BaoCaoHoatDongYTeLaoDong6ThangNamTuyenHuyen/tpl/model.html'),
		schema = require('json!schema/BaoCaoHoatDongYTeLaoDong6ThangNamTuyenHuyenSchema.json');
	var PhanLoaiCoSoLaoDongTheoNganhNgheVaQuyMoItemView = require('app/baocao/BaoCaoHoatDongYTeLaoDong6ThangNamTuyenHuyen/js/PhanLoaiCoSoLaoDongTheoNganhNgheVaQuyMoView');
	var PhanLoaiCoSoLaoDongCoYeuToCoHaiNguyHiemItemView = require('app/baocao/BaoCaoHoatDongYTeLaoDong6ThangNamTuyenHuyen/js/PhanLoaiCoSoLaoDongCoYeuToCoHaiNguyHiemView');
	var KetQuaQuanTracCacYeuToViKhiHauVaVatLyHoaHocItemView = require('app/baocao/BaoCaoHoatDongYTeLaoDong6ThangNamTuyenHuyen/js/KetQuaQuanTracCacYeuToViKhiHauVaVatLyHoaHocView');
	var KetQuaQuanTracCacYeuToBuiTrongMoiTruongLaoDongItemView = require('app/baocao/BaoCaoHoatDongYTeLaoDong6ThangNamTuyenHuyen/js/KetQuaQuanTracCacYeuToBuiTrongMoiTruongLaoDongView');
	var KetQuaDanhGiaCacYeuToTiepXucNgheNghiepItemView = require('app/baocao/BaoCaoHoatDongYTeLaoDong6ThangNamTuyenHuyen/js/KetQuaDanhGiaCacYeuToTiepXucNgheNghiepView');
	var TinhHinhNghiOmItemView = require('app/baocao/BaoCaoHoatDongYTeLaoDong6ThangNamTuyenHuyen/js/TinhHinhNghiOmView');
	var TongSoTruongHopMacCacLoaiBenhThongThuongItemView = require('app/baocao/BaoCaoHoatDongYTeLaoDong6ThangNamTuyenHuyen/js/TongSoTruongHopMacCacLoaiBenhThongThuongView');
	var CacTruongHopMacBenhNgheNghiepPhuLuc9ItemView = require('app/baocao/BaoCaoHoatDongYTeLaoDong6ThangNamTuyenHuyen/js/CacTruongHopMacBenhNgheNghiepPhuLuc9View');
	var CacTruongHopTaiNanLaoDongPhuLuc9ItemView = require('app/baocao/BaoCaoHoatDongYTeLaoDong6ThangNamTuyenHuyen/js/CacTruongHopTaiNanLaoDongPhuLuc9View');
	var KetQuaKhamPhatHienBenhNgheNghiepItemView = require('app/baocao/BaoCaoHoatDongYTeLaoDong6ThangNamTuyenHuyen/js/KetQuaKhamPhatHienBenhNgheNghiepView');
	var DanhSachNguoiMacBenhNgheNghiepItemView = require('app/baocao/BaoCaoHoatDongYTeLaoDong6ThangNamTuyenHuyen/js/DanhSachNguoiMacBenhNgheNghiepView');
	var TongHopTuBaoCaoCuaCacCoSoLaoDongItemView = require('app/baocao/BaoCaoHoatDongYTeLaoDong6ThangNamTuyenHuyen/js/TongHopTuBaoCaoCuaCacCoSoLaoDongView');
	var CacHoatDongDoDonViTrienKhaiItemView = require('app/baocao/BaoCaoHoatDongYTeLaoDong6ThangNamTuyenHuyen/js/CacHoatDongDoDonViTrienKhaiView');
	var PhanLoaiCacTruongHopTaiNanLaoDongTheoViecSoCuuItemView = require('app/baocao/BaoCaoHoatDongYTeLaoDong6ThangNamTuyenHuyen/js/PhanLoaiCacTruongHopTaiNanLaoDongTheoViecSoCuuView');
	var PhanLoaiCacTruongHopTaiNanLaoDongTheoNganhNgheItemView = require('app/baocao/BaoCaoHoatDongYTeLaoDong6ThangNamTuyenHuyen/js/PhanLoaiCacTruongHopTaiNanLaoDongTheoNganhNgheView');
	var KinhPhiChiTraItemView = require('app/baocao/BaoCaoHoatDongYTeLaoDong6ThangNamTuyenHuyen/js/KinhPhiChiTraView');
