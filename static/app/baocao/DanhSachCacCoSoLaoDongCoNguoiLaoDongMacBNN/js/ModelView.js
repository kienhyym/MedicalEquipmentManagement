define(function (require) {
	...
	var template = require('text!app/baocao/DanhSachCacCoSoLaoDongCoNguoiLaoDongMacBNN/tpl/model.html'),
		schema = require('json!schema/BaoCaoDanhSachCacCoSoLaoDongCoNguoiLaoDongMacBenhNgheNgiepSchema.json');
		
	var BaoCaoDanhSachCacCoSoLaoDongCoNguoiLaoDongMacBenhNgheNgiepItemView = require('app/baocao/DanhSachCacCoSoLaoDongCoNguoiLaoDongMacBNN/js/BaoCaoDanhSachCacCoSoLaoDongCoNguoiLaoDongMacBenhNgheNgiepItemView');
