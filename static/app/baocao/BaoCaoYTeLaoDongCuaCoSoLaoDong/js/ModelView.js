define(function (require) {
	...
	var template = require('text!app/baocao/BaoCaoYTeLaoDongCuaCoSoLaoDong/tpl/model.html'),
		schema = require('json!schema/BaoCaoYTeLaoDongCuaCoSoLaoDongSchema.json');

	var NghiViecDoOmDauTaiNanLaoDongVaBenhNgheNghiepItemView = require('app/baocao/BaoCaoYTeLaoDongCuaCoSoLaoDong/js/NghiViecDoOmDauTaiNanLaoDongVaBenhNgheNghiepView');
	var CongTacThanhTraItemView = require('app/baocao/BaoCaoYTeLaoDongCuaCoSoLaoDong/js/CongTacThanhTraView');
	var TinhHinhBenhNgheNghiepTaiCoSoItemView = require('app/baocao/BaoCaoYTeLaoDongCuaCoSoLaoDong/js/TinhHinhBenhNgheNghiepTaiCoSoView');
	var DanhSachTruongHopBenhNgheNghiepItemView = require('app/baocao/BaoCaoYTeLaoDongCuaCoSoLaoDong/js/DanhSachTruongHopBenhNgheNghiepView');
	var ThongKeTongSoTruongHopMacCacLoaiBenhThongThuongItemView = require('app/baocao/BaoCaoYTeLaoDongCuaCoSoLaoDong/js/ThongKeTongSoTruongHopMacCacLoaiBenhThongThuongView');
	var CacTruongHopMacBenhNgheNghiepItemView = require('app/baocao/BaoCaoYTeLaoDongCuaCoSoLaoDong/js/CacTruongHopMacBenhNgheNghiepView');
	var CacTruongHopTaiNanLaoDongItemView = require('app/baocao/BaoCaoYTeLaoDongCuaCoSoLaoDong/js/CacTruongHopTaiNanLaoDongView');
	var CongTacHuanLuyenItemView = require('app/baocao/BaoCaoYTeLaoDongCuaCoSoLaoDong/js/CongTacHuanLuyenView');
	var KinhPhiVeSinhLaoDongVaChamSocSucKhoeNguoiLaoDongItemView = require('app/baocao/BaoCaoYTeLaoDongCuaCoSoLaoDong/js/KinhPhiVeSinhLaoDongVaChamSocSucKhoeNguoiLaoDongView');
	var CacKienNghiDuKienVaKeHoachDuKienTrongKyToiItemView = require('app/baocao/BaoCaoYTeLaoDongCuaCoSoLaoDong/js/CacKienNghiDuKienVaKeHoachDuKienTrongKyToiView');
