define(function (require) {
    ...
    var itemTemplate = require('text!app/hosonguoilaodong/mobilehososuckhoevabenhtat/tpl/bangquanlybenhmantinhtheotungbenh.html'),
        itemSchema = require('json!schema/BangQuanLyBenhManTinhTheoTungBenhSchema.json');
    var BangQuanLyBenhManTinhTheoTungBenhChiTietItemView = require('app/hosonguoilaodong/mobilehososuckhoevabenhtat/js/BangQuanLyBenhManTinhTheoTungBenhChiTietView');
