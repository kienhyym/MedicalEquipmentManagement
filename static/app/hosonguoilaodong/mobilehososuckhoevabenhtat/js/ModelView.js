define(function (require) {
	...
	var template = require('text!app/hosonguoilaodong/mobilehososuckhoevabenhtat/tpl/model.html'),
		schema = require('json!schema/HSQLSucKhoeVaBenhTatNguoiLaoDongSchema.json');

	var BangQLSucKhoeTruocKhiBoTriViecLamItemView = require('app/hosonguoilaodong/mobilehososuckhoevabenhtat/js/BangQLSucKhoeTruocKhiBoTriViecLamView');
	var BangQLSucKhoeLaoDongThongQuaKhamSucKhoeDinhKyItemView = require('app/hosonguoilaodong/mobilehososuckhoevabenhtat/js/BangQLSucKhoeLaoDongThongQuaKhamSucKhoeDinhKyView');
	var BangSoTruongHopMacCacLoaiBenhThongThuongItemView = require('app/hosonguoilaodong/mobilehososuckhoevabenhtat/js/BangSoTruongHopMacCacLoaiBenhThongThuongVIew');

	var BangCacTruongHopMacBenhNgheNghiepItemView = require('app/hosonguoilaodong/mobilehososuckhoevabenhtat/js/BangCacTruongHopMacBenhNgheNghiepView');
	var BangCacTruongHopTaiNanLaoDongItemView = require('app/hosonguoilaodong/mobilehososuckhoevabenhtat/js/BangCacTruongHopTaiNanLaoDongView');
	// var BangTinhHinhNghiViecItemView = require('app/hosonguoilaodong/mobilehososuckhoevabenhtat/js/BangTinhHinhNghiViecView');
	var BangQuanLyBenhManTinhItemView = require('app/hosonguoilaodong/mobilehososuckhoevabenhtat/js/BangQuanLyBenhManTinhView');
	var BangQuanLyBenhManTinhTheoTungBenhView = require('app/hosonguoilaodong/mobilehososuckhoevabenhtat/js/BangQuanLyBenhManTinhTheoTungBenhView');
	var BangTheoDoiBenhNgheNghiepItemView = require('app/hosonguoilaodong/mobilehososuckhoevabenhtat/js/BangTheoDoiBenhNgheNghiepView');
	var BangDanhSachNguoiLaoDongMacBenhNgheNghiepItemView = require('app/hosonguoilaodong/mobilehososuckhoevabenhtat/js/BangDanhSachNguoiLaoDongMacBenhNgheNghiepView');
	var BangTinhHinhNghiViecView = require('app/hosonguoilaodong/mobilehososuckhoevabenhtat/js/BangTinhHinhNghiViecView');
