define(function (require) {
	...
	var template = require('text!app/baocao2/phuluc7/tpl/model.html'),
		schema = require('json!schema/HoSoBenhNgheNghiepSchema.json');

	var TomTatDienBienSucKhoeHangNamItemView = require('app/baocao2/phuluc7/js/TomTatDienBienSucKhoeHangNamItemView');
