...
class User(CommonModel):
    ...
    quanhuyen_id = db.Column(UUID(as_uuid=True), nullable=True)
    quanhuyen = db.Column(JSONB)
    xaphuong_id = db.Column(UUID(as_uuid=True), nullable=True)
...
class KeHoachThanhTra(CommonModel):
    ...
    userid_nguoixemxet = db.Column(String)
    username_nguoixemxet = db.Column(String)
    ngayxemxet = db.Column(DateTime)
    userid_nguoipheduyet = db.Column(String)
    username_nguoipheduyet = db.Column(String)
    ngaypheduyet = db.Column(DateTime)
