...
class BangQLSucKhoeTruocKhiBoTriViecLam(CommonModel):
    ...
    phanloaisuckhoeloai1 =db.Column(db.Integer())
    phanloaisuckhoeloai2 = db.Column(db.Integer())
    phanloaisuckhoeloai3 = db.Column(db.Integer())
    phanloaisuckhoeloai4 = db.Column(db.Integer())
    phanloaisuckhoeloai5 = db.Column(db.Integer())
