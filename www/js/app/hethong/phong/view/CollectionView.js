define(function (require) {
	...
	var template = require('../../../../../../static/app/hethong/room/view/node_modules/text!app/hethong/room/tpl/collection.html'),
	...
	return Gonrin.CollectionView.extend({
		...
		render_grid: function (dataSource) {
			...
			element.grid({
				...
				events: {
					"rowclick": function (e) {
						self.getApp().getRouter().navigate("room/model?id=" + e.rowId);
					},
				},
			});
