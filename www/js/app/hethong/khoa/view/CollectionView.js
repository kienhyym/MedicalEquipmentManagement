define(function (require) {
	...
	var template = require('../../../../../../static/app/hethong/department/view/node_modules/text!app/hethong/department/tpl/collection.html'),
	...
	return Gonrin.CollectionView.extend({
		...
		render_grid: function (dataSource) {
			...
			element.grid({
				...
				events: {
					"rowclick": function (e) {
						self.getApp().getRouter().navigate("department/model?id=" + e.rowId);
					},
				},
			});
